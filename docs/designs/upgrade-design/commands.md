...
helm upgrade documentdb-operator ./developer-tooling/documentdb-helm-chart --version v2.0.0
...
helm upgrade documentdb-operator ./developer-tooling/documentdb-helm-chart --version v3.0.0
...
helm upgrade documentdb-operator ./developer-tooling/documentdb-helm-chart --version v4.0.0
